...
description: "Create or add React components in the Khryuchik project. Use when creating a new component, page-view, shared UI block, admin form section, barrel export, index.ts, or types.ts that must follow the repository folder structure."
