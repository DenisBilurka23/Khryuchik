...
export const AdminCategoryCard = ({
  ...
  const deletionDisabled =
    category.itemsCount > 0 || category.key === BOOKS_CATEGORY_KEY;
  const deleteBlockedReason =
    category.key === BOOKS_CATEGORY_KEY
    ...
    <AdminSectionCard
      ...
      action={
        <Stack direction="row" gap={1} flexWrap="wrap">
          <AdminStatusChip
            label={
              category.isActive ? sharedStatus.active : sharedStatus.hidden
            }
        ...
        <Stack gap={2}>
          ...
          >
            ...
            <TextField
              ...
              name="ru.label"
              defaultValue={category.translations.ru?.label ?? ""}
              required
            />
            <TextField
              label={labels.fields.enLabel}
              name="en.label"
              defaultValue={category.translations.en?.label ?? ""}
              required
            />
          </Box>
          <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1 }}>
            ...
            <AdminCheckboxField
              control={
                <Checkbox
                  name="visibleInShop"
                  defaultChecked={category.visibleInShop}
                />
              }
            ...
            <AdminCheckboxField
              control={
                <Checkbox
                  name="visibleInHomeTabs"
                  defaultChecked={category.visibleInHomeTabs}
                />
              }
