  ...
  adminPage: {
    ...
    dashboard: {
      ...
      stats: {
        ...
        featuredNote: "Products currently promoted in priority storefront placements",
      },
      recentProducts: {
    ...
    productForm: {
      ...
      infoAlert:
        "Images and PDF files are uploaded to R2 through this form. JSON fields are used for options, reviews, and specs arrays so real catalog data stays intact.",
      ...
      helpers: {
        placements: "Comma-separated: shop, home-books, home-shop",
        flags: "Comma-separated merchandising badges",
        ...
        optionsRule: "Each line is a separate option. For example: English or Russian.",
        specsRule: "Each line is a separate specification. For example: Format: PDF",
